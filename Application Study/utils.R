...
lasso_eval <- function(lasso_result, prop = 0.5) {
  # Return >= prop, Granger Causal
...
oracle_lasso_eval <- function(lasso_result, prop = 0.5) {
  # Return >= prop, Granger Causal
  Output <- vector("list", length = 4)
  Output[[1]] <- apply(lasso_result$W0, 3, function(zzz) mean(colSums(zzz) != 0))
  Output[[2]] <- (Output[[1]][1] >= prop)
  Output[[3]] <- prop
  Output[[4]] <- lasso_result$Lambdas
  names(Output) <- c("Votes", "Decision", "Level", "Lambda")
...
produce_tableV1 <- function() {
  rows <- 1:12
  tablefull <- tibble(Length = rep(c(250, 500, 1000), each = 4), Model = rep(rep(c("VAR", "TAR"), each = 2), 3), Decision = rep(c("GC", "NC"), 6)) 
  tablefull <- tablefull %>% 
    mutate(NPGC05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(NPGC10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
    mutate(GAUSS = sapply(rows, function(zz) {mean(unlist(lapply(GAUSS100[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {gauss_eval(xx, alpha = 0.10)$Decision})))})) %>% 
    mutate(ZERO = sapply(rows, function(zz) {mean(unlist(lapply(ZERO100[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {zero_eval(xx, prop = 0.5)$Decision})))})) %>%
    mutate(LASSO1MV = sapply(rows, function(zz) {mean(unlist(lapply(LASSO1[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.5)$Decision})))})) %>% 
    mutate(LASSO1ONE = sapply(rows, function(zz) {mean(unlist(lapply(LASSO1[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.001)$Decision})))})) %>% 
    mutate(LASSO2MV = sapply(rows, function(zz) {mean(unlist(lapply(LASSO2[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.5)$Decision})))})) %>% 
    mutate(LASSO2ONE = sapply(rows, function(zz) {mean(unlist(lapply(LASSO2[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.001)$Decision})))})) %>% 
    mutate(LASSO3MV = sapply(rows, function(zz) {mean(unlist(lapply(LASSO3[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.5)$Decision})))})) %>% 
    mutate(LASSO3ONE = sapply(rows, function(zz) {mean(unlist(lapply(LASSO3[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.001)$Decision})))})) %>% 
    mutate(LASSO4MV = sapply(rows, function(zz) {mean(unlist(lapply(LASSO4[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.5)$Decision})))})) %>% 
    mutate(LASSO4ONE = sapply(rows, function(zz) {mean(unlist(lapply(LASSO4[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.001)$Decision})))})) %>% 
    mutate(LASSO5MV = sapply(rows, function(zz) {mean(unlist(lapply(LASSO5[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.5)$Decision})))})) %>% 
    mutate(LASSO5ONE = sapply(rows, function(zz) {mean(unlist(lapply(LASSO5[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {lasso_eval(xx, prop = 0.001)$Decision})))}))
}

produce_tableV2 <- function() {
  rows <- 1:36
...
produce_tableV4 <- function(alpha) {
  ...
  tablefull <- tibble(Length = rep(c(250, 500, 1000), each = 4), Model = rep(rep(c("VAR", "TAR"), each = 2), 3), Decision = rep(c("GC", "NC"), 6)) 
  tablefull <- tablefull %>% 
    mutate(tanh_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(relu_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_20[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(leaky_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_21[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(tanh_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
    mutate(relu_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_20[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
    mutate(leaky_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_21[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))}))
}

produce_tableV5 <- function(alpha) {
  rows <- 1:12
  tablefull <- tibble(Length = rep(c(250, 500, 1000), each = 4), Model = rep(rep(c("VAR", "TAR"), each = 2), 3), Decision = rep(c("GC", "NC"), 6)) 
  tablefull <- tablefull %>% 
    mutate(lag2_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(lag4_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_22[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(lag8_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_25[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(lag2_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
    mutate(lag4_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_22[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
    mutate(lag8_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_25[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))}))
}

produce_tableV6 <- function(alpha) {
  rows <- 1:12
  tablefull <- tibble(Length = rep(c(250, 500, 1000), each = 4), Model = rep(rep(c("VAR", "TAR"), each = 2), 3), Decision = rep(c("GC", "NC"), 6)) 
  tablefull <- tablefull %>% 
    mutate(ELM_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(MLP_05 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC2[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.05)$Decision})))})) %>%
    mutate(ELM_10 = sapply(rows, function(zz) {mean(unlist(lapply(NPGC_19[which(str_detect(datakey$Model, tablefull$Model[zz]) & str_detect(datakey$GC, tablefull$Decision[zz]) & datakey$Length == tablefull$Length[zz])], function(xx) {npgc_eval(xx, alpha = 0.10)$Decision})))})) %>%
